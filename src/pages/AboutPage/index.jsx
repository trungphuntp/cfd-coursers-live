                ...
                <div className="banner__content">
                    <div className="container">
                        <h2 className="title --white">
                            <span>Sứ mệnh</span> của CFD Circle là kết nối, truyền đạt kinh nghiệm
                            thực tế và khởi dậy cảm hứng từ những người tâm huyết để tạo ra sản phẩm
                            chất lượng cao.
                        </h2>
                    </div>
                </div>
                ...
                <div className="container">
                    ...
                    <div className="aboutstory__content">
                        ...
                        <p className="text">
                            ...
                            nhưng khi đi làm cho các doanh nghiệp thì phải đào tạo lại? Làm sao để
                            giúp được cho những bạn trái ngành có thể học và đi làm trong thời gian
                            ngắn nhất? Và làm thế nào để tạo ra nhiều sản phẩm website có trải
                            nghiệm người dùng tốt nhất? <br />
                            <br />
                            Từ đó, CFD Circle ra đời để giải quyết tất cả những vấn đề trên với mong
                            muốn tạo ra nhiều sản phẩm website chất lượng, tinh tế và có giá trị cao
            ...
            <section className="aboutbenifit --scpadding">
                <div className="container">
                    <h2 className="aboutbenifit__title title --t2">
                        Chúng ta sẽ <span className="color--primary">đồng hành cùng nhau</span>{" "}
                        <br />
                ...
                <div className="container">
                    ...
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            ...
                            <div className="text">
                                Với trang thiết bị hiện đại, đội ngũ giảng viên &amp; mentor sẽ sát
                                cánh cùng bạn trong khoá học offline tại học viện CFD Circle ở số
                                11b, Phan Kế Bính, Đa Kao, Quận 1, TP Hồ Chí Minh.
                            </div>
                    ...
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            ...
                            <div className="text">
                                ...
                                video chia sẻ màn hình và được giảng viên, mentor hỗ trợ như khi bạn
                                học offline.
                            </div>
                            <a href="courses.html" className="btn btn--primary">
                                Khám phá
                    ...
                    <div className="aboutstudy__item">
                        ...
                        <div className="aboutstudy__item-content">
                            ...
                            <div className="text">
                                Nền tảng học online của CFD Circle có rất nhiều khoá học video, bạn
                                có thể học bất kỳ khi nào mình muốn. Đặc biệt, bạn sẽ được hỗ trợ từ
                                giảng viên thông qua Google Meet hoặc đội ngũ mentor của CFD Circle.
                            </div>
                            <a href="courses.html" className="btn btn--primary">
                                Khám phá
                            </a>
            ...
            <section className="aboutgallery --scpadding">
                <div className="container">
                    <h2 className="aboutgallery__title title --t2 --white">
                        CFD Circle <span className="color--primary">là một team gắn kết,</span>{" "}
                        <br />
            ...
            <section className="callregister">
                <div className="container">
                    <div className="callregister__content">
                        ...
                        <p>
                            Chúng tôi rất vui khi bạn quyết định trở thành một phần của CFD Circle
                            để cùng nhau học hỏi, lan toả và chia sẻ những kinh nghiệm quý giá cho
                            cộng đồng.
                        </p>
                        <a href="courses.html" className="btn btn--primary">
                            Tham gia Khoá học
