                ...
                <div className="blog__list">
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            ...
                            <h2 className="title --t3">
                                <a href="blog-detail.html">Top 5 bản thiết kế landing page figma miễn phí dành cho front-end dev và designer</a>
                            </h2>
                    ...
                    <div className="blog__list-item">
                        ...
                        <div className="content">
                            <p className="label">Dev</p>
                            <h2 className="title --t3">
                                <a href="blog-detail.html">ReactJS là gì? Tại sao ReactJs là thư viện Javascript phổ biến nhất hiện nay</a>
                            </h2>
                            <div className="content__info">
                                <div className="user">
                                    <div className="user__img">
